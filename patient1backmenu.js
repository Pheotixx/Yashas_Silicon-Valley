class Docpatientbackmenu{
    ...
    display(){
        ...
        this.patient.mousePressed(()=>{
            ...
            this.title.position(windowWidth/2-275, windowHeight/2);
            ...
            this.back.mousePressed(()=>{
                ...
                var backmenu = new Docpatientmenu();
                backmenu.display();
        ...
        this.reports.mousePressed(()=>{
            ...
            this.title2.html("Here the doctor can view or upload the results of the medical tests given by the patient");
